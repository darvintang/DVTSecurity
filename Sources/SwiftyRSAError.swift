    ...
    public var errorDescription: String? {
        switch self {
            ...
            case let .signatureCreateFailed(description):
                return "Couldn't sign provided data: \(description)"
            case let .signatureVerifyFailed(description):
                return "Couldn't verify signature of the provided data: \(description)"
            ...
            case let .encryptFailed(description):
                return "Couldn't encrypt from key data: \(description)"
            case let .decryptFailed(description):
                return "Couldn't decrypt from key data: \(description)"
        }
    }
}
